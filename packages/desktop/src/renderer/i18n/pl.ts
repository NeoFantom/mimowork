export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji MemoWork",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} MemoWork. Czy chcesz ją zainstalować i uruchomić ponownie?",
