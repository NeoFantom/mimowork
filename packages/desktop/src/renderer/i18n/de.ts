export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von MemoWork",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von MemoWork wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
