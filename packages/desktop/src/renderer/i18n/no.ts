export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av MemoWork",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av MemoWork er lastet ned. Vil du installere den og starte på nytt?",
