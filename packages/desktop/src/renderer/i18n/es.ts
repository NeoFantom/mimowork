export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de MemoWork",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de MemoWork. ¿Quieres instalarla y reiniciar?",
