export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'MemoWork",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'MemoWork a été téléchargée. Voulez-vous l'installer et redémarrer ?",
