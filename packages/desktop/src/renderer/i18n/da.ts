export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af MemoWork",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af MemoWork er blevet downloadet. Vil du installere den og genstarte?",
